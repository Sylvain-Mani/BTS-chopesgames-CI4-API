...
// ! Génération automatique : php spark make:controller CategorieController -restful
...
{
    protected $modelName  = 'App\models\Categorie';
    ...
    public function index()
    {
        $data = [
            'message' => 'success',
            //'data_categorie' => $this->model->findAll()
            'data_categorie' => $this->model->orderBy('LIBELLE', 'DESC')->findAll()
        ];
    ...
    public function create()
    {
        ...
        $this->model->insert([
            'LIBELLE' => esc($this->request->getVar('nom'))
        ]);
